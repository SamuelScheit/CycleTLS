...
var CycleTLSResults = []CycleTLSOptions{
	...
	// 	200},
	{
		"7a7a639628f0fe5c7e057628a5bbec5a",
		"771,4867-4865-4866-49196-49195-49188-49187-49162-49161-52393-49200-49199-49192-49191-49172-49171-52392-157-156-61-60-53-47-49160-49170-10,65281-0-23-13-5-13172-18-16-11-51-45-43-10-21,29-23-24-25,0",
		"WhatsApp/545529030 CFNetwork/978.0.7 Darwin/18.7.0",
		200,
	},
}
...
func TestHTTP2(t *testing.T) {
	...
	for _, options := range CycleTLSResults {
		...
		t.Log("Testing:", options.Ja3Hash, "with", options.UserAgent, "and", options.Ja3)

		response, err := client.Do("https://tls.peet.ws/api/clean", cycletls.Options{
		// response, err := client.Do("https://check.ja3.zone/", cycletls.Options{
		...
		t.Log("Response:", response.Status, response.Body)
